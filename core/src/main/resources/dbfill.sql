...
VALUES
    ...
    (1, 'Java Developer', 'Lublin', 'Umowa o pracę', 60000.00, '2024-04-30', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
    (1, 'IT Specialist', 'Gniezno', 'Kontrakt B2B', 50000.00, '2024-04-30', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
    (1, 'Frontend Developer', 'Kraków', 'Kontrakt B2B', 55000.00, '2024-06-15', 'Looking for a skilled frontend developer with React experience.'),
    ...
    (1, 'Data Scientist', 'Warszawa', 'Kontrakt B2B', 70000.00, '2024-05-20', 'Join us as a data scientist to help analyze big data and drive business insights.'),
    ...
    (1, 'Product Manager', 'Poznań', 'Kontrakt B2B', 75000.00, '2024-06-01', 'Experienced product manager needed to lead product development and strategy.'),
    ...
    (1, 'Business Analyst', 'Katowice', 'Kontrakt B2B', 55000.00, '2024-07-10', 'Looking for a business analyst to work on project requirements and process improvements.'),
    ...
    (1, 'Software Architect', 'Lublin', 'Kontrakt B2B', 80000.00, '2024-07-20', 'Seeking a software architect to design scalable and efficient software solutions.'),
